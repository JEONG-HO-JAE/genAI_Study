...
class LinearScheduler(Scheduler):
    ...
    def __init__(self, T: int, beta_start: float, beta_end: float):
        ...
        self._betas = torch.linspace(beta_start, beta_end, T)
        self._alphas = 1.0 - self._betas
        self._alpha_hat = torch.cumprod(self._alphas, dim=0)
        ...
        self._beta_hat = (1 - self._alpha_hat_t_minus_1) / (1 - self._alpha_hat) * self._betas
