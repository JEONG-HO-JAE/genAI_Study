...
from models.ddpm import GaussianDDPM
import torchvision
...
def main():
    ...
    model = GaussianDDPM(denoiser_module=denoiser, 
                         T=model_hparams.T, 
                         width=model_hparams.width,
                         height=model_hparams.height, 
                         input_channels=model_hparams.input_channels,
                         logging_freq=1000, 
                         v=model_hparams.v,
